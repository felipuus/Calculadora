...
document.getElementById("a").addEventListener("click",o1);
document.getElementById("s").addEventListener("click",o2);
...
function o1() {
	let actual = document.getElementById('resultado').innerHTML;
	let sumado = document.getElementById("a").innerHTML;
	document.getElementById('resultado').innerHTML = actual + sumado
}
...
function showResult() {
	let actual = document.getElementById('resultado').innerHTML;
    let somar = actual.indexOf("+");
    let diminuir = actual.indexOf("-")
    let dividir = actual.indexOf("÷")
    let multiplic = actual.indexOf("x");
    if (somar !== -1)
